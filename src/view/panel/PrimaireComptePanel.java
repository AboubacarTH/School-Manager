 ...
 * @author ATH
 */
public class PrimaireComptePanel extends javax.swing.JPanel {

    /**
     * Creates new form ComptePanel
     */
    public PrimaireComptePanel() {
    ...
    private void initComponents() {
        ...
        btn_activer_all_saisie_s3 = new javax.swing.JButton();
        btn_desactiver_all_saisie_s3 = new javax.swing.JButton();
        ...
        table_utilisateur.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "N°", "N° Matricule", "Nom et Prénom", "Administrateur", "Professeur", "Ajout", "Modification", "Supression", "Trim. 1", "Trim. 2", "Trim. 3", "Dernière Connexion"
            }
        ) {
        ...
        if (table_utilisateur.getColumnModel().getColumnCount() > 0) {
            ...
            table_utilisateur.getColumnModel().getColumn(10).setPreferredWidth(75);
            table_utilisateur.getColumnModel().getColumn(10).setMaxWidth(100);
            table_utilisateur.getColumnModel().getColumn(11).setPreferredWidth(150);
            table_utilisateur.getColumnModel().getColumn(11).setMaxWidth(180);
        }
        ...
        btn_activer_all_saisie_s1.setText("Activer les saisies  T1");
        ...
        btn_desactiver_all_saisie_s1.setText("Désactiver les saisies T1");
        ...
        btn_activer_all_saisie_s2.setText("Activer les saisies T2");
        ...
        btn_desactiver_all_saisie_s2.setText("Désactiver les saisies T2");
        ...
        btn_activer_all_saisie_s3.setText("Activer les saisies T3");
        btn_activer_all_saisie_s3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_activer_all_saisie_s3ActionPerformed(evt);
            }
        });

        btn_desactiver_all_saisie_s3.setText("Désactiver les saisies T3");
        btn_desactiver_all_saisie_s3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_desactiver_all_saisie_s3ActionPerformed(evt);
            }
        });
    ...
    private void btn_activer_all_saisie_s1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_activer_all_saisie_s1ActionPerformed
        int choice = JOptionPane.showConfirmDialog(this, "Etes vous sure de vouloir activer la saisie pour tous les enseignents pour les notes 1er Trimestre ?", "Information", JOptionPane.YES_NO_OPTION);
        if (choice == 0) {
    ...
    private void btn_activer_all_saisie_s2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_activer_all_saisie_s2ActionPerformed
        int choice = JOptionPane.showConfirmDialog(this, "Etes vous sure de vouloir activer la saisie pour tous les enseignents pour les notes 2e Trimestre ?", "Information", JOptionPane.YES_NO_OPTION);
        if (choice == 0) {
    ...
    private void btn_activer_all_saisie_s3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_activer_all_saisie_s3ActionPerformed
        int choice = JOptionPane.showConfirmDialog(this, "Etes vous sure de vouloir activer la saisie pour tous les enseignents pour les notes 3e Trimestre ?", "Information", JOptionPane.YES_NO_OPTION);
        if (choice == 0) {
            getController().getDroitController().activeAllSaisieProfS3();
            table_utilisateur();
        }
    }//GEN-LAST:event_btn_activer_all_saisie_s3ActionPerformed

    private void btn_desactiver_all_saisie_s3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_desactiver_all_saisie_s3ActionPerformed
        getController().getDroitController().desactiveAllSaisieProfS3();
        table_utilisateur();
    }//GEN-LAST:event_btn_desactiver_all_saisie_s3ActionPerformed
    ...
    private void table_utilisateur() {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            row[10] = droit == null ? "o" : droit.isS3() ? "x" : "";
            if (journal != null) {
                row[11] = simpleDateFormat.format(journal.getDate());
            } else {
                row[11] = "---";
            }
