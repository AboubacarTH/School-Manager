 ...
 * @author ATH
 */
public class MatiereClasseDialog extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public MatiereClasseDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        id_cb_annees = new HashMap<>();
        id_cb_cycles = new HashMap<>();
        id_table_classes = new HashMap<>();
        list_classes = new ArrayList<>();
        this.matiereClasse = null;
        id_cb_type_matiere = new HashMap<>();
        id_cb_matieres = new HashMap<>();
        initComponents();
        init_combo_box_annee();
        init_combo_box_cycle();
        init_combo_box_matiere_type();
    ...
    public MatiereClasseDialog(java.awt.Frame parent, boolean modal, MatiereClasse matiereClasse) {
        super(parent, modal);
        id_cb_annees = new HashMap<>();
        id_cb_cycles = new HashMap<>();
        id_table_classes = new HashMap<>();
        ...
        popup();
        try {
            Classe classe = getController().getClasseController().get(this.matiereClasse.getId_classe());
            id_table_classes.put(0, classe.getId());
            list_classes.add(classe.getId());
            id_cb_cycles.put(0, classe.getId_cycle());
            Matiere matiere = getController().getMatiereController().get(this.matiereClasse.getId_matiere());
            MatiereType matiereType = getController().getMatiereTypeController().get(matiere.getId_matiere_type());
            id_cb_matieres.put(0, matiere.getId());
            id_cb_type_matiere.put(0, matiereType.getId());
            ...
            combo_box_type_matiere.setSelectedItem(matiereType.getType());
            combo_box_type_matiere.setEnabled(false);
            combo_box_matiere.setSelectedItem(matiere.getMatiere());
            combo_box_matiere.setEnabled(false);
            spinner_volume_horaire.setValue(matiereClasse.getVolume_horaire());
            spinner_coefficient.setValue(matiereClasse.getCoefficient());
    ...
    private void initComponents() {
        ...
        spinner_volume_horaire = new javax.swing.JSpinner();
        spinner_coefficient = new javax.swing.JSpinner();
        jLabel6 = new javax.swing.JLabel();
        jLabel7 = new javax.swing.JLabel();
        combo_box_annee = new javax.swing.JComboBox<>();
        combo_box_cycle = new javax.swing.JComboBox<>();
        combo_box_type_matiere = new javax.swing.JComboBox<>();
        ...
        jLabel3.setText("Type Matière :");

        jLabel4.setText("Vol. horaire :");

        jLabel5.setText("Coefficient :");

        spinner_volume_horaire.setModel(new javax.swing.SpinnerNumberModel(0, 0, null, 1));

        spinner_coefficient.setModel(new javax.swing.SpinnerNumberModel(1, 1, null, 1));
        ...
        combo_box_type_matiere.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        combo_box_type_matiere.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                combo_box_type_matiereActionPerformed(evt);
            }
        });
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(jScrollPane_table_classe_selected, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(combo_box_type_matiere, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(combo_box_matiere, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(spinner_coefficient, javax.swing.GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE)
                                    .addComponent(spinner_volume_horaire))))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jScrollPane_table_classe_selected, javax.swing.GroupLayout.PREFERRED_SIZE, 154, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel3)
                            .addComponent(combo_box_type_matiere, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel4)
                            .addComponent(spinner_volume_horaire, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel5)
                            .addComponent(spinner_coefficient, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void combo_box_type_matiereActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_combo_box_type_matiereActionPerformed
        init_combo_box_matiere();
    }//GEN-LAST:event_combo_box_type_matiereActionPerformed
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            MatiereClasseDialog dialog = new MatiereClasseDialog(new javax.swing.JFrame(), true);
    ...
    private final MatiereClasse matiereClasse;
    private final HashMap<Integer, Long> id_cb_annees, id_cb_cycles, id_cb_type_matiere, id_cb_matieres, id_table_classes;
    ...
    private javax.swing.JComboBox<String> combo_box_type_matiere;
    ...
    private javax.swing.JSpinner spinner_coefficient;
    private javax.swing.JSpinner spinner_volume_horaire;
    ...
    private void init_combo_box_matiere_type() {
        combo_box_type_matiere.removeAllItems();
        id_cb_type_matiere.clear();
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            combo_box_type_matiere.addItem(matiereType.getType());
            id_cb_type_matiere.put(i, matiereType.getId());
        }
    }

    private void init_combo_box_matiere() {
        combo_box_matiere.removeAllItems();
        id_cb_matieres.clear();
        Long id_matiere_type = id_cb_type_matiere.get(combo_box_type_matiere.getSelectedIndex());
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            id_cb_matieres.put(i, matiere.getId());
        }
    }
    ...
    private void action_button_ok() {
        if (combo_box_annee.getSelectedIndex() < 0 || combo_box_cycle.getSelectedIndex() < 0 || combo_box_type_matiere.getSelectedIndex() < 0 || combo_box_matiere.getSelectedIndex() < 0) {
            JOptionPane.showMessageDialog(this, "Veuillez remplir tous les champs ", "Champ vide ou manquant !", JOptionPane.WARNING_MESSAGE);
            return;
        }
        Long id_matiere = id_cb_matieres.get(combo_box_matiere.getSelectedIndex());
        //verifier si la matiere classe existe sinon on le cree
        list_classes.forEach((id_classe) -> {
            MatiereClasse mc = getController().getMatiereClasseController().get(id_matiere, id_classe);
            if (mc == null) {
                getController().getMatiereClasseController().add(
                        id_matiere,
                        id_classe,
                        (int) spinner_volume_horaire.getValue(),
                        (int) spinner_coefficient.getValue()
                );
            } else {
                getController().getMatiereClasseController().update(
                        mc.getId(),
                        id_matiere,
                        id_classe,
                        (int) spinner_volume_horaire.getValue(),
