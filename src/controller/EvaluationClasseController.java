 ...
 * @author ATH
 */
public class EvaluationClasseController {

    private final Connection connection;
    private PreparedStatement preparedStatement;
    private ResultSet resultSet;

    public EvaluationClasseController(Connection connection) {
    ...
    private void add(Long id_eleve, Long id_classe, Long id_semestre) {
        try {
            ...
            Logger.getLogger(EvaluationClasseController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void update(Long id_eleve, Long id_classe, Long id_semestre) {
        ...
        try {
            String req = "SELECT SUM(evaluation_matieres.note_coefficient) AS sommeMoyenne, SUM(evaluation_matieres.coefficient) AS sommeCoefficient FROM evaluation_matieres "
            ...
            if (resultSet.next()) {
                ...
                if (denomunateur != 0) {
                    moyenne = numerateur / denomunateur;
                }
            }
